...
public class HomeController {
	...
	public ModelAndView test01(@RequestParam(defaultValue="hello") String name) 
			throws Exception{
		...
		if(name.equals("hello")){
			//예외 객체 생성해서 던지기
			throw new CustomException("파라미터가 전달이 안됬네?");
		}
		
		return mView;
	}
	/*
	 * CustomException type의 예외가  발생하면 예외를 처리할 메소드
	 */
	@ExceptionHandler(CustomException.class)
	public ModelAndView handleException1(CustomException ce){
